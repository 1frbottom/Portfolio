...
>**해결 과정 :**
>
>- 1차 (2026.05) : 풀링으로 런타임 스폰 제거. Sweep OFF, 피격은 거리 판정, 체력바는 Material CPD로 교체. 프레임타임 `40ms` 구간까지 방어.<br><br>
...
>- 네트워크 :
>   - 복제 액터 `100` → `800`, 송신은 `5.6KB/s` → `3.5~4.0KB/s`로 같거나 더 낮음. 스터터링 해소.
<br><br>
...
| Preview & Info |
| :---: |
| <img src="https://github.com/user-attachments/assets/483934f5-500e-42bd-9590-93aa69fa0205" width="600"> |
